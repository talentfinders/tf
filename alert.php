...
<script src="vendor/jquery/jquery.js"></script>
 ...
 <link href="vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
	...
	<body >
		 <!-- Navigation -->
     <nav class="navbar navbar-custom-alert navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
				...
				<ul class="nav navbar-nav">
                    ...
                    <i class="fa fa-bell  bigger-120"></i>
                </a>
                    </li>
...
<hr>
   ...
   <footer class="blog-footer2">
	 ...
	 <p>&copy; 2016 Talentfinders Developpers &middot; <a href="about.php"><?php echo $L1 ;?></a>&middot; <a href="contact.php"><?php echo $L25 ;?></a>&middot; <a href="job.php"><?php echo $L26 ;?></a>&middot; <a href="rule.php"><?php echo $L27 ;?></a> 
	   <?php 
...
function collapseNavbar() {
    if ($(".navbar").offset().top > 50) {
        $(".navbar-fixed-top").addClass("top-nav-alert");
    } else {
        $(".navbar-fixed-top").removeClass("top-nav-alert");
    }
}
