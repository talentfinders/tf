...
<script src="vendor/jquery/jquery.js"></script>
 ...
 <link href="vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
	...
	<body >
		 <!-- Navigation -->
     <nav class="navbar navbar-custom-rule navbar-fixed-top" role="navigation">
        <div class="container">
...
<br><br><br>
<div class="page-header rule center">
...
function collapseNavbar() {
    if ($(".navbar").offset().top > 50) {
        $(".navbar-fixed-top").addClass("top-nav-rule");
    } else {
        $(".navbar-fixed-top").removeClass("top-nav-rule");
    }
}
