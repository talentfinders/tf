...
<script src="vendor/jquery/jquery.js"></script>
 ...
 <link href="vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
	...
	<body >
		 <!-- Navigation -->
     <nav class="navbar navbar-custom-contact navbar-fixed-top" role="navigation">
        <div class="container">
...
<br><br><br>
<div class="page-header contact center">
					
								<?php echo $L25 ;?>
								<span class="glyphicon
glyphicon-phone-alt "></span>
								</div>       
<br>				
<div class="container ">
<div class="row">
...
<h3><?php echo $L75 ;?></h3>
<hr>
<diV class="social-login  col-md-4  col-lg-4"><a class="btn btn-success">
													<i class="ace-icon fa fa-whatsapp"></i>
												</a><h5>+23 49 030 255 894</h5> </div><br>
<diV class="social-login  col-md-4 col-lg-4"><a class="btn btn-primary">
													<i class="ace-icon fa fa-facebook"></i>
												</a><h5>Talentfinders</h5> </div><br>

<diV class="social-login  col-md-4  col-lg-4"><a class="btn btn-danger">
													<i class="ace-icon fa fa-youtube-square"></i>
												</a><h5>@Talentfinders</h5> </div>
												
												<br><hr>
												
<diV class="social-login  col-md-4  col-lg-4"><a class="btn btn-info">
													<i class="ace-icon fa fa-twitter"></i>
												</a><h5>@Talentfinders</h5> </div><br>
												
<diV class="social-login  col-md-4  col-lg-4"><a class="btn btn-danger">
													<i class="ace-icon fa fa-google"></i>
												</a><h5>Talentfindersofficial@gmail.com</h5> </div><br>
<diV class="social-login  col-md-4  col-lg-4"><a class="btn ">
...
function collapseNavbar() {
    if ($(".navbar").offset().top > 50) {
        $(".navbar-fixed-top").addClass("top-nav-contact");
    } else {
        $(".navbar-fixed-top").removeClass("top-nav-contact");
    }
}
