...
<br><br><br>
<div class="page-header don ">	</div>       
<br>				
<div class="container ">
<div class="row">
<div class="col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
      <div class="panel panel " style="">
        <div  class="panel-heading center" style="background-color:white; font-size:25px; color:gray; border:1px solid white; ">Donate now to help us keep our vision alive</div>
...
<input type="hidden" name="hosted_button_id" value="AU95A379AH6GE">
