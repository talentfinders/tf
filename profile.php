...
if (isset($_SESSION['pseudo']))
 ...
 $query2 = $bdd->query("	SELECT * FROM connect where membreConnect='".$_SESSION['pseudo']."'")->rowcount(); 
	
	$image = $bdd->query("	SELECT * FROM photo where Auteur ='".$_SESSION['pseudo']."' order by idPhoto desc limit 15 "); 
if (isset($_SESSION['pseudo']))
	{
$followers = $bdd->query("	SELECT *  FROM follow,membres,profile where membres.pseudo=profile.nomMemb and profile.nomMemb=follow.suiveur and suivie ='".$_SESSION['pseudo']."'"); 
$following = $bdd->query("	SELECT *  FROM follow,membres,profile where  membres.pseudo=profile.nomMemb and profile.nomMemb=follow.suivie and suiveur ='".$_SESSION['pseudo']."'"); 
$follow = $bdd->query("	SELECT * ,count(suiveur) as nbfollowers FROM follow where suivie ='".$_SESSION['pseudo']."'")->fetch(); 
$followi = $bdd->query("SELECT * ,count(suivie) as nbfollowing FROM follow where suiveur ='".$_SESSION['pseudo']."'")->fetch(); 
...
<div class="container ">
 ...
 <div class="row">
  <div class="">
							...
							<a href="assets/images/avatars/user/<?php echo $query['photo'];?>" class="group1" title=" <?php echo $query['pseudo']; ?>" >
		...
		<img id="avatar" class="editable img-responsive" src="assets/images/avatars/user/<?php echo $query['photo'];?>" alt="Photo" />
												...
												<div class="tools">
																		<div class="action-buttons bigger-125">
																			<a data-toggle="modal"  href="#edittof">
																				<i class="ace-icon fa fa-pencil blue"><?php echo $L89 ;?></i>
																			</a>
			...
			{
				echo  '<span classe="progress" style="color:red; font-size:14px; ">'.htmlspecialchars($_SESSION['resultat_telecharg']).'</span>';
											...
											<div class="profile-user-info " style="background-color:white;">
																<div class="profile-info-row">
																	...
																	<div class="profile-info-value">
																		<span><?php echo $query['pseudo'];?></span>
																			...
																			<a data-toggle="modal"  href="#Pseudo">
																				<i class="ace-icon fa fa-pencil blue bigger-125"><?php echo $L90 ;?></i>
																			</a>
																...
																<div class="profile-info-row">
																	...
																	<div class="profile-info-value">
																		...
																		<span><?php echo $query['nom'];?></span>
																			...
																			<a data-toggle="modal"  href="#Fullname">
																				<i class="ace-icon fa fa-pencil blue bigger-125"><?php echo $L90 ;?></i>
																			</a>
																...
																<div class="profile-info-row">
																	...
																	<div class="profile-info-value">
																		...
																		<a data-toggle="modal"  href="#career">
																				<i class="ace-icon fa fa-pencil blue bigger-125"><?php echo $L90 ;?></i>
																			</a>
																	</div>
																</div>
...
<div class="row">											
  ...
  <diV class="social-login col-lg-offset-1 col-md-offset-1 col-sm-2 col-md-2 col-lg-2"><a class="btn btn-primary">
													<i class="ace-icon fa fa-facebook"></i><a data-toggle="modal"  href="#facebook">
																				<i class="ace-icon fa fa-pencil blue bigger-125"><?php echo $L90 ;?></i>
																			</a>
	...
	<diV class="social-login col-sm-2 col-md-2 col-lg-2"><a class="btn btn-info">
 													...
 													<i class="ace-icon fa fa-twitter"></i><a data-toggle="modal"  href="#twitter">
																				<i class="ace-icon fa fa-pencil blue bigger-125"><?php echo $L90 ;?></i>
																			</a>
	 ...
	 <diV class="social-login col-sm-2 col-md-2 col-lg-2"><a class="btn ">
													...
													<i class="ace-icon fa fa-instagram"></i><a data-toggle="modal"  href="#instagram">
																				<i class="ace-icon fa fa-pencil blue bigger-125"><?php echo $L90 ;?></i>
																			</a>
	...
	<diV class="social-login col-sm-2 col-md-2 col-lg-2"><a class="btn btn-danger">
													...
													<i class="ace-icon fa fa-envelope"></i><a data-toggle="modal"  href="#email">
																				<i class="ace-icon fa fa-pencil blue bigger-125"><?php echo $L90 ;?></i>
																			</a>
 ...
 <?php if(isset($_SESSION['pseudo']) && ($_SESSION['pseudo'] == ucfirst(strtolower(htmlspecialchars($videoselect['Auteur'])))))
 {?>
	
																					
																						<a href="scripts/delete-photo-pro.php?id=<?php echo  $videoselect['idPhoto']; ?>" class="tooltip-error pull-right"  title="Delete">
																							<span class="red">
...
<h4 class="modal-title  blue lighter bigger">
												...
												<input type="text" name="email" placeholder="<?php echo $L15 ;?>" >
												<button type="submit" class="btn btn-success" name="">SEND</button>
...
<h4 class="modal-title  blue lighter bigger">
												...
												<input type="text" name="pseudo" placeholder="<?php echo $L9 ;?>" >
												<button type="submit" class="btn btn-success" name="">SEND</button>
