...
$sp = $bdd->query("	SELECT * FROM sponsors where type='physique' order by idSP desc "); 
$sp2 = $bdd->query("	SELECT * FROM sponsors where type='morale' order by idSP desc "); 
...
<script src="vendor/jquery/jquery.js"></script>
 ...
 <link href="vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
	...
	<body >
		 <!-- Navigation -->
     <nav class="navbar navbar-custom-sponsor navbar-fixed-top" role="navigation">
        <div class="container">
...
<br><br><br>
<div class="page-header sponsor center">
...
{ 
 ...
 ?>
<a href="<?php echo $mor['lien'];?>"><img src="assets/images/sponsors/<?php echo $mor['logoSP']; ?>" alt="<?php echo $mor['nomSP']; ?>"/></a>
<?php
...
{ 
 ...
 ?>
<a href="<?php echo $phy['lien'];?>"><img src="assets/images/sponsors/<?php echo $phy['logoSP']; ?>" alt="<?php echo $phy['nomSP']; ?>"/></a>
<?php
...
function collapseNavbar() {
    if ($(".navbar").offset().top > 50) {
        $(".navbar-fixed-top").addClass("top-nav-sponsor");
    } else {
        $(".navbar-fixed-top").removeClass("top-nav-sponsor");
    }
}
